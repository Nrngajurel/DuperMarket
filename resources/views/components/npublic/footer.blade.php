<div {{ $attributes  }}>
    <div class="container pt-3">
        <div class="row">
            <div class="col-md-3">
                <h1 class="no-margin h3 footer-app-name text-warning">
                    <a href="{{ route('home') }}" class="text-decoration-none no-margin text-capitalize">{{ config('app.name') }}</a>
                </h1>
                <p class="">
            ...
            <div class="col-md-3">
                <h1 class="no-margin h3 text-warning">
